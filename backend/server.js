...
app.post("/main", async (req, res) => {
  try {
    ...
    const promptTemplate = emailPrompts[outputType] || emailPrompts.Internship;
    ...
    const generatedEmailContent = responsechat.choices[0].message.content;

    console.log("Generated Email Content:", generatedEmailContent);
